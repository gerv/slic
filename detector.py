...
_license_parts = {
    ...
    'GPLAny': {
        ...
        'match':  r"GNU General Public License|Licensed under the GPL-2 or later",
        ...
        'subs': {
            ...
            'GPL20': {
                ...
                'match':  r"GNU General Public License.*(version|V) ?2[ ,.]" + \
    ...
    'LGPLAny': {
        'start':  r"This file (may|can)",
        'match':  r"under the terms of the GNU Lesser General Public License\.?$",
        'end':    r"GNU Lesser General Public License\.?$"
    },
    'LGPL_ref': {
    ...
    'copying_fileref2': {
        'start':  r"See.*COPYING for licensing terms",
        'match':  r"See.*COPYING for licensing terms",
        'end':    r"See.*COPYING for licensing terms"
    ...
    'po_fileref': {
        'start':  r"This file is distributed under the same license as the .* package.",
...
def extract_copyrights_and_license(text, tag):
    ...
    for i in range(len(text)):
        ...
        if re.search("copyright ?[\d\(©]", line, re.IGNORECASE) or \
           re.search("copyright.*\d{4}", line, re.IGNORECASE):
