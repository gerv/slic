...
_license_parts = {
    ...
    'GPLAny_3': {
        ...
        'end':    r"incorporated herein by reference"
    },
    ...
    'GPL20_fileref7': {
        'start':  r"OSS/Free for Linux is distributed under the GNU GENERAL PUBLIC",
    ...
    'LGPLAny': {
        ...
        'end':    r"under the terms of the GNU Lesser General Public License\.?$"
    },
    'LGPL_ref': {
